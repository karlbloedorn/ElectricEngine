...
bool SceneryItem::LoadFromObj(string basePath, string filePath){
	...
	string a ="rock_diffuse.png";// materials[0].diffuse_texname;
	glGenTextures(1, &texture);
	Textures::SetupTexture(texture, basePath + a, true);
